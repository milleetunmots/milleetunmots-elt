...
families AS (
    SELECT 
        ...
        {{ get_goals_follow_up('call3_previous_goals_follow_up') }} AS call3_previous_goals_follow_up,
        ...
        call2_review,
        call3_review,
        call0_sendings_benefits_details,
        call1_sendings_benefits_details,
        call2_sendings_benefits_details,
        call3_sendings_benefits_details,
        stop_support_reason,
        date_stop_support
    FROM child_supports
),
...
SELECT distinct
    ...
    concat(COALESCE(SUBSTR(p1.postal_code, 1, 2), ''), '_', COALESCE(LPAD(TRIM(so.department), 2, '0'), '')) AS source_or_family_department,
    ...
    f.call3_previous_goals_follow_up,
    ...
    f.call0_sendings_benefits_details,
    f.call1_sendings_benefits_details,
    f.call2_sendings_benefits_details,
    f.call3_sendings_benefits_details,
