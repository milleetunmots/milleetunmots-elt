...
select
    ...
    nullif(trim(rtrim(call0_status::string)), '') as call0_status,
    ...
    nullif(trim(rtrim(call1_status::string)), '') as call1_status,
    ...
    nullif(trim(rtrim(call2_status::string)), '') as call2_status,
    ...
    nullif(trim(rtrim(call3_status::string)), '') as call3_status,
